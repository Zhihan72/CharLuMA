...
deepspeed  --include localhost:0,1,2,3,4,5,6,7 ./llava/train/train_mem.py \
    ...
    --data_path ./training_dataset/ChartMoE-Data/chartmoe_json.json \
    --image_folder ./training_dataset/ChartMoE-Data \
    ...
    --bf16 True \
    --output_dir ./checkpoints/ckpt_pretrain_ChartMoEAlign_json \
    --num_train_epochs 1 \
