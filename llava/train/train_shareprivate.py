...
class LazySupervisedDataset(Dataset):
    ...
    def _filter_overlong_prompts(self, example: Dict[str, Any]) -> bool:
        ...
        return len(input_ids) <= self.tokenizer.model_max_length
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        data_dict["lang_type"] = self.list_data_dict[i]['id'].split("_")[0] # for charluma
...
class DataCollatorForSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        batch['lang_type'] = lang_type # for charluma
...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            special_keys = ("shareprivate", "residual", "sharebias", "sulora", "murmoe")
            if any(k in model_args.mm_projector_type.lower() for k in special_keys):
